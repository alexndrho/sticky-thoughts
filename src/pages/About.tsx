    ...
    <Container role="main" size="lg" className={classes.main}>
      <Box>
        ...
        <Text mt="lg" fz="lg">
          ...
          yourself and share your thoughts and experiences with others. You have
          the option to remain anonymous or not. You can post anything that you
          want including your thoughts, experiences, and even your secrets. You
          can also read other people's notes. The notes can be customized by
          using different colors, and you can search for other people's notes by
          their names. There is no limit to the number of notes you can add.
        </Text>
